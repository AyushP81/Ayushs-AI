...
function getAIResponse(input) {
  ...
  if (input.includes("do you know thej moodley")) {
    reply = "Ah, Thej Moodley? 😏 Of course! With hair that long, I bet he has its own Wi-Fi hotspot somewhere in there! 🌪️💻 Just don’t get caught in a breeze near him!";
}
